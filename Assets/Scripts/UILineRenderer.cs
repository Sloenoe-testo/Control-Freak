...
namespace Radishmouse
{
    ...
    {
        public static List<GameObject> pointsList = new();
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            {
                // Create a line segment between the next two pointsList
                CreateLineSegment(pointsList[i].transform.position, pointsList[i + 1].transform.position, vh);
                ...
                // the last line segment and the start pointsList of this one
                if (i != 0)
                {
                    vh.AddTriangle(index, index - 1, index - 3);
        ...
        /// <summary>
        /// Creates a rect from two pointsList that acts as a line segment
        /// </summary>
